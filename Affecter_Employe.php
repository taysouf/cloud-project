  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        ...
        <br><small>Affecter Employé</small>
      </h1>
    </section>
        ...
        <div class="box col-sm-12" >
          ...
          <div class="box-body table-responsive">
              <table id="example1" class="table table-bordered table-striped">
                <thead><tr><th>MATRICULE</th><th>CardID</th><th>NOM</th><th>PRENOM</th><th>EMAIL</th><th>DATE D'ENTREE</th><th>AFFECTER</th></tr></thead>
                <tfoot><tr><th>MATRICULE</th><th>CardID</th><th>NOM</th><th>PRENOM</th><th>EMAIL</th><th>DATE D'ENTREE</th><th>AFFECTER</th></tr></tfoot>
                <tbody>
                <?php
                      foreach ($r as $employe) {
                        ...
                        echo $employe['matricule'];
                        echo ")\"><i class=\"fa fa-sign-in\"></i></button></td>";
                        echo "</tr>";
                      }
                ?>
                </tbody>  
