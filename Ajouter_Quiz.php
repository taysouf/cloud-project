...
<div id="messageInfo"></div>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview menu-open active">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="Ajouter_Quiz.php"><i class="fa fa-plus-square"></i> Ajouter Quiz</a></li>
          </ul>
        </li>
  ...
  <div class="content-wrapper">
    ...
    <div class="col-md-8">
  <div class="col-sm-5">
 <select id="pr" onchange="showSteps(this.value)" class="form-control" >
<option value="default" disabled selected="selected" >default</option> 
<option selected hidden disabled>Projects</option>
                          <?php 
                           $result= getProjets();

                            foreach($result as $row_select){
                              $projectId = $row_select['projetId'];
                              $designation = $row_select['designation'];
                              ?>
                                <option value="<?php echo $projectId ?>"><?php echo "$designation" ?></option>
                              <?php
                            }
                           ?></select>
   </div>
   
    <div id="Steps" class="col-md-7"></div>
  <br>
  
  <div id="Questions" class="col-md-10" style="margin-top: 3em;" ></div>
