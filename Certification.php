  ...
  <div class="content-wrapper">
    ...
    <section class="content row">
        ...
        <div class="box col-sm-12 table-responsive" >
        	...
        	<div class="box-header">Liste des Projets</div>
        	<div class="box-body">
              <table id="example1" class="table table-bordered table-striped text-uppercase">
                <thead><tr><th>PROJET_ID</th><th>PROJET</th><th>ZONE</th><th>CLIENT</th><th>CHOIX</th></tr></thead>
                <tfoot><tr><th>PROJET_ID</th><th>PROJET</th><th>ZONE</th><th>CLIENT</th><th>CHOIX</th></tr></tfoot>
                <tbody>
                <?php
                      foreach ($r as $projet) {
                        echo "<tr>";
                        echo "<td>";
                        echo $projet['projetId'];
                        echo "</td>";
                        echo "<td>";
                        echo $projet['designation'];
                        echo "</td>";
                        echo "<td>";
                        echo $projet['zone'];
                        echo "</td>";
                        ...
                        echo $projet['client'];
                        echo "</td>";
                        echo "<td style=\"text-align: center;\"><button title=\"Choisir projet\" type=\"button\" class=\"btn btn-primary btn-xs\" onclick=\"certificationPage(";
                        echo $projet['projetId'];
