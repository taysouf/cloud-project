...
<div class="wrapper">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="header">&nbsp;</li>
        <li class="active"><a href="Logs.php"><i class="fa fa-history"></i><span>Historique & Logs</span></a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Logs & Historique
        <br><small>Liste des opérations effectuées</small>
      </h1>
    </section>
    ...
    <section class="content row">
        ...
        <div class="box col-sm-12 table-responsive" >
        	...
        	<div class="box-header">Liste des opérations</div>
        	<div class="box-body">
              <table id="example1" class="table">
                <thead><tr><th>LOG ID</th><th>OPERATION</th><th>TYPE</th><th>DATE</th></tr></thead>
                <tbody>
                <?php
                      foreach ($r as $log) {
                        echo "<tr>";
