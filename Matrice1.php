  ...
  <div class="content-wrapper">
    ...
    <section class="content row">
        ...
        <div class="box col-sm-12" >
          ...
          <div class="pull-right"><button type="button" class="btn btn-primary" onclick="window.location.href = 'print1.php?projetId=<?php echo $projetId; ?>';"><i class="fa fa-print"></i> Imprimer</button></div>
          </div>
          <div class="box-body table-responsive">
              <table id="example1" class="table table-bordered table-striped text-uppercase">
                <thead><tr><th></th><th></th><th colspan=<?php echo (count($steps)); ?> class="text-center warning">Steps</th></tr>
                <tr><th>Nom & Prénom</th><th class="text-center">MTC</th><?php foreach ($steps as $st ) {
                  echo "<th class=\"text-center\">".$st['designation']."</th>";
                } ?></tr></thead>
