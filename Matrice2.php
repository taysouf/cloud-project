      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview menu-open active">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="Rapport_Employé.php"><i class="fa fa-table"></i> Par Employé</a></li>
          </ul>
        </li>
            ...
            <div class="row">
              ...
              <div class="box-body table-responsive">
                <table id="example1" class=" table table-bordered table-striped text-uppercase">
                  <thead><tr><th>ZONE</th><th>PROJET</th><th>CLIENT</th><th>STEP</th><th>NIVEAU A</th><th>NIVEAU B</th><th>NIVEAU C</th><th>NIVEAU D</th></tr></thead>
                  <tbody>
                  <?php
                        foreach ($r as $projet) {
                          echo "<tr>";
                          ...
                          echo $projet['nomStep'];
                          echo "</td>";
                          echo "<td class=\"text-center\" >".$projet['dateA']."</td>";
                          if (isset($projet['dateD'])) {
                          	echo "<td class=\"text-center\" >".$projet['dateB']."</td>";
                          	echo "<td class=\"text-center\" >".$projet['dateC']."</td>";
                          	echo "<td class=\"text-center\" >".$projet['dateD']."</td>";
                          }elseif (isset($projet['dateC'])) {
                          	echo "<td class=\"text-center\" >".$projet['dateB']."</td>";
                          	echo "<td class=\"text-center\" >".$projet['dateC']."</td>";
                          	echo "<td></td>";
                          }elseif (isset($projet['dateB'])) {
                          	echo "<td class=\"text-center\" >".$projet['dateB']."</td>";
                          	echo "<td></td>";
                          	echo "<td></td>";
                          }else{
