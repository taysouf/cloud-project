              ...
              <table id="example1" class="table table-bordered table-striped text-uppercase">
                ...
                <?php
                      foreach ($r as $projet) {
                        ...
                        echo $projet['client'];
                        echo "</td>";
                        echo "<td style=\"text-align: center;\"><button title=\"chosir\" type=\"button\" class=\"btn btn-primary btn-xs\" onclick=\"matriceProjetPage(";
                        echo $projet['projetId'];
                        echo ")\"><i class=\"fa fa-info-circle\"></i></button></td>";
                        echo "</tr>";
                      }
                ?>
                </tbody>  
