      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview menu-open active">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="Supprimer_Employe.php"><i class="fa fa-trash"></i> Supprimer Employé</a></li>
          </ul>
        </li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        ...
        <br><small>Supprimer Employé</small>
      </h1>
    </section>
    ...
    <section class="content">
        ...
        <div class="box col-sm-12" >
          ...
          <div class="box-header">Liste des employés</div>
          <div class="box-body table-responsive">
              <table id="example1" class="table table-bordered table-striped">
                <thead><tr><th>MATRICULE</th><th>CardID</th><th>NOM</th><th>PRENOM</th><th>EMAIL</th><th>DATE D'ENTREE</th><th>SUPPRIMER</th></tr></thead>
                <tfoot><tr><th>MATRICULE</th><th>CardID</th><th>NOM</th><th>PRENOM</th><th>EMAIL</th><th>DATE D'ENTREE</th><th>SUPPRIMER</th></tr></tfoot>
                <tbody>
                <?php
