...
if (!empty($_GET['matricule'])) {
  ...
  header('Location:Modifier_Employe.php');
}
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview menu-open active">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="Modifier_Employe.php"><i class="fa fa-edit"></i> Modifier Employé</a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        ...
        <br><small>Modification Employé</small>
      </h1>
    </section>
    ...
    <section class="content">
      <div class="row">
        ...
        <div class="col-md-10">
          <form class="form-horizontal" id="formEmploye">
            ...
            <fieldset class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input required="true" type="text"  value="<?php echo $employe['nom']; ?>" class="form-control" id="nom" placeholder="Entrer le nom" name="nom">
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input required="true" type="text"  value="<?php echo $employe['prenom']; ?>" class="form-control" id="prenom" placeholder="Entrer le prénom" name="prenom">
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input required="true" type="date"  value="<?php echo $employe['dateNaissance']; ?>" class="form-control" id="dateNaissance" placeholder="Enter la date de naissance" name="dateNaissance">
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input required="true" type="email" class="form-control"  value="<?php echo $employe['email']; ?>" id="email" placeholder="Enter l'email" name="email">
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input required="true" type="text" class="form-control"  value="<?php echo $employe['niveauEtude']; ?>" id="niveauEtude" placeholder="Entrer le niveau d'études" name="niveauEtude">
                </div>
              </div>
              </fieldset>
              <br>                    
          ...
          <div class="row col-md-10 col-sm-offset-1">
                  <button style="width: 150px;" id="btn-submitFormMod" class="btn btn-success col-sm-offset-3">Enregistrer</button>
